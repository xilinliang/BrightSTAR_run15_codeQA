// Filename: TStNanoDiffJetTreeMaker_zerobias.cxx
// Description: 
...
#include "TStNanoDiffJetTreeMaker_zerobias.h"
...
ClassImp(TStNanoDiffJetTreeMaker_zerobias)

//_____________________________________________________________________________ 
TStNanoDiffJetTreeMaker_zerobias::TStNanoDiffJetTreeMaker_zerobias(const char *name):StMaker(name)
{
...
//_____________________________________________________________________________ 
TStNanoDiffJetTreeMaker_zerobias::~TStNanoDiffJetTreeMaker_zerobias()
{
    //
    delete mOutJetEvent;
...
//_____________________________________________________________________________ 
Int_t TStNanoDiffJetTreeMaker_zerobias::Init()
{
...
//_____________________________________________________________________________
Int_t TStNanoDiffJetTreeMaker_zerobias::Make()
{
    ...
    {
	LOG_ERROR << "TStNanoDiffJetTreeMaker_zerobias::Make - No JetMaker or SkimEventMaker found" <<endm;
	return kStFatal;	
    }
...
//    }	
    ...
    nPosVertex = 0;
    NPrimaryVertex = mMuDst->numberOfPrimaryVertices(); 
    //cout << "Number of Primary Vertex:" << NPrimaryVertex << endl;
    for (Int_t i=0; i < NPrimaryVertex; i++)
    {

    	mMuPrimaryVertex = mMuDst->primaryVertex(i);
	//cout << mMuPrimaryVertex->ranking() << "	";
	if (mMuPrimaryVertex->ranking() > 0) {nPosVertex = nPosVertex +1;}


    }
    //cout << endl;
    mOutSkimEvent->SetNPosVertex(nPosVertex);
...
//_____________________________________________________________________________
Int_t TStNanoDiffJetTreeMaker_zerobias::MakeRps()
{
    //------ Using afterburner ----
...
//_____________________________________________________________________________
Int_t TStNanoDiffJetTreeMaker_zerobias::Finish()
{
...
//_____________________________________________________________________________
void TStNanoDiffJetTreeMaker_zerobias::SetTrigIds(Int_t *trigIds)
{
