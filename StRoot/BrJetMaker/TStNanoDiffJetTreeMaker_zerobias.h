// Filename: TStNanoDiffJetTreeMaker_zerobias.h
// Description: 
// Author: Latif Kabir < kabir@bnl.gov >
// Created: Mon Aug 19 17:38:04 2019 (-0400)
// URL: jlab.org/~latif

#ifndef TSTNANODIFFJETTREEMAKER_ZEROBIAS_H
#define TSTNANODIFFJETTREEMAKER_ZEROBIAS_H
...
class TStNanoDiffJetTreeMaker_zerobias : public StMaker
{
private:
    StMuDst *mMuDst;  
    StEvent* mEvent;
    StMuEvent *mMuEvent;
    StMuPrimaryVertex *mMuPrimaryVertex;
...
public: 
    TStNanoDiffJetTreeMaker_zerobias(const char *name  = "NanoJetTreeMaker");
    virtual ~TStNanoDiffJetTreeMaker_zerobias();
    virtual Int_t Init();
    virtual Int_t Make();
    ...
    ClassDef(TStNanoDiffJetTreeMaker_zerobias,1) 
};
