...
public:    
    ...
    Int_t GetNPosVertex(){return mNPosVertex;}
    ...
    Double_t GetTofEtaMin(){return mTofEtaMin;}
    ...
    void SetNPosVertex(Int_t nPVtx){ mNPosVertex = nPVtx;}
    ...
    void SetTofEtaMin(Double_t tofetam){mTofEtaMin = tofetam;}
