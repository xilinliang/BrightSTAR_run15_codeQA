// Filename: TStNanoDiffJetTreeMaker_ZDCTOF.h
// Description: 
// Author: Latif Kabir < kabir@bnl.gov >
// Created: Mon Aug 19 17:38:04 2019 (-0400)
// URL: jlab.org/~latif

#ifndef TSTNANODIFFJETTREEMAKER_ZDCTOF_H
#define TSTNANODIFFJETTREEMAKER_ZDCTOF_H
...
class TStNanoDiffJetTreeMaker_ZDCTOF : public StMaker
{
private:
    StMuDst *mMuDst;  
    StEvent* mEvent;
...
public: 
    TStNanoDiffJetTreeMaker_ZDCTOF(const char *name  = "NanoJetTreeMaker");
    virtual ~TStNanoDiffJetTreeMaker_ZDCTOF();
    virtual Int_t Init();
    virtual Int_t Make();
    ...
    ClassDef(TStNanoDiffJetTreeMaker_ZDCTOF,1) 
};
