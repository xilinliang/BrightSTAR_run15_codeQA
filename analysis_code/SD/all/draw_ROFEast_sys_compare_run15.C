void draw_ROFEast_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_East_Sys_ROF.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_East_Sys_ROF_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("ROFW450_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_East_result.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[1] >> YellowANErr_4045[1]  ;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_East_SysROF.txt");
...
//    	inputtext.open("ANtext/Run15FMSfinal_SysROF_m10.txt");
//
//	inputtext >> beam >> XFpoint >> AN_1520[1] >> ANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> YellowAN_1520[1] >> YellowANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> AN_2025[1] >> ANErr_2025[1]  ;
...
//    	inputtext.open("ANtext/Run15FMSfinal_SysROF_p10.txt");
//
...
//    	inputtext.open("ANtext/Run15FMSfinal_SysROF_p20.txt");
//
...
//	//YellowANDiff_un_3045[4] = sqrt(fabs(pow(YellowANErr_3045[4] , 2) - pow(YellowANErr_3045[2] ,2)));
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_ROFstudy_East_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_ROFstudy_East_Sys.pdf");
