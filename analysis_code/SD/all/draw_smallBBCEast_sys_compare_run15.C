void draw_smallBBCEast_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_East_Sys_smallBBC.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_East_Sys_smallBBC_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("smallBBCW450_12np.txt");
	...
	//cout << "Blue AN 0.2 - 0.25:" << AN_2025[2] << "	Yellow AN 0.2 - 0.25:" << YellowAN_2025[2] << endl;

    	ifstream inputtext;
    	//inputtext.open("smallBBCW350_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_East_SyssmallBBC_m20.txt");
	...
	//cout << "Blue AN 0.2 - 0.25:" << AN_2025[0] << "	Yellow AN 0.2 - 0.25:" << YellowAN_2025[0] << endl;
	...
	//YellowANDiff_un_far[4] = YellowANDiff_un_3045[0];
    	...
    	ifstream inputtext;
    	//inputtext.open("smallBBCW400_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_East_SyssmallBBC_m10.txt");
	...
	//YellowANDiff_un_3045[1] = sqrt(fabs(pow(YellowANErr_3045[1] , 2) - pow(YellowANErr_3045[2] ,2)));
    	...
    	//ifstream inputtext;
    	////inputtext.open("smallBBCW450_12np.txt");
    	//inputtext.open("smallBBCW550.txt");
    	//inputtext.open("ANtext/Run15FMSfinal_East_SyssmallBBC_m10.txt");
	...
	//YellowANDiff_un_3045[2] = 0;
    	...
    	ifstream inputtext;
    	//inputtext.open("smallBBCW500_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_East_SyssmallBBC_p10.txt");
	...
	//YellowANDiff_un_3045[3] = sqrt(fabs(pow(YellowANErr_3045[3] , 2) - pow(YellowANErr_3045[2] ,2)));
    	...
    	ifstream inputtext;
    	//inputtext.open("smallBBCW550_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_East_SyssmallBBC_p20.txt");
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_smallBBCstudy_East_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_smallBBCstudy_East_Sys.pdf");
