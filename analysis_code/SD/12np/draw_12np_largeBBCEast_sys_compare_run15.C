void draw_12np_largeBBCEast_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_12np_East_Sys_largeBBC.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_12np_East_Sys_largeBBC_noconstrain.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[2] >> YellowANErr_4045[2]  ;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_East_SyslargeBBC_m20.txt");
	...
	//YellowANDiff_un_far[4] = YellowANDiff_un_3045[0];
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_East_SyslargeBBC_m10.txt");
	...
	//YellowANDiff_un_3045[2] = 0;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_East_SyslargeBBC_p10.txt");
	...
	//YellowANDiff_un_3045[3] = sqrt(fabs(pow(YellowANErr_3045[3] , 2) - pow(YellowANErr_3045[2] ,2)));
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_East_SyslargeBBC_p20.txt");
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_largeBBCstudy_East_12np_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_largeBBCstudy_East_12np_Sys.pdf");
