void draw_3pnp_ROFEast_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_3pnp_East_Sys_ROF.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_3pnp_East_Sys_ROF_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("ROFW450_3pnp.txt");
    	inputtext.open("ANtext/Run15FMSfinal_3pnp_East_result.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[1] >> YellowANErr_4045[1]  ;
    	...
    	ifstream inputtext;
    	//inputtext.open("ROFW350_3pnp.txt");
    	inputtext.open("ANtext/Run15FMSfinal_3pnp_East_SysROF.txt");
...
//    	ifstream inputtext;
//    	//inputtext.open("ROFW400_3pnp.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_3pnp_SysROF_m10.txt");
//
//	inputtext >> beam >> XFpoint >> AN_1520[1] >> ANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> YellowAN_1520[1] >> YellowANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> AN_2025[1] >> ANErr_2025[1]  ;
...
//
//    	ifstream inputtext;
//    	//inputtext.open("ROFW500_3pnp.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_3pnp_SysROF_p10.txt");
//
...
//
//    	ifstream inputtext;
//    	//inputtext.open("ROFW550_3pnp.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_3pnp_SysROF_p20.txt");
//
...
//	//YellowANDiff_un_3045[4] = sqrt(fabs(pow(YellowANErr_3045[4] , 2) - pow(YellowANErr_3045[2] ,2)));
	...
	TH2D * temp = new TH2D("temp","Blue beam A_{N}",8,0.15,0.45,30,-0.15,0.15);
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_ROFstudy_East_3pnp_Sys.pdf");
...
//
	TCanvas *ANplot = new TCanvas("ANPlot","",1024,768);
	ANplot->DrawFrame(2., -0.06, 250., 0.2);
	TH2D * temp = new TH2D("temp","Yellow beam A_{N}",8,0.15,0.45,30,-0.15,0.15);
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_ROFstudy_East_3pnp_Sys.pdf");
