void Calc_3pnp_systematic_All_5ptE()
{

	ifstream com_sig;
	com_sig.open("ANtext/Run15FMSfinal_3pnp_East_result.txt");
	ifstream SBBC;
	SBBC.open("ANtext/Run15FMSfinal_3pnp_East_Sys_smallBBC.txt");
	ifstream LBBC;
	LBBC.open("ANtext/Run15FMSfinal_3pnp_East_Sys_largeBBC.txt");
	ifstream ROF;
	ROF.open("ANtext/Run15FMSfinal_3pnp_East_Sys_ROF.txt");
	ifstream bkg;
	bkg.open("ANtext/frac_east_bkg_3pnp.txt");
	//ifstream Dilution;
	//Dilution.open("ANtext/Run15FMScase23_EnergyCorrectionCompare4.txt");
	//ifstream Esum;
	//Esum.open("ANtext/Run15FMSfinal_3pnp_EastSys_Esum.txt");
	//ifstream MixBkg;
	//MixBkg.open("frac_sys.txt");

	ofstream resultfile;
	resultfile.open("finalANtext/run15_FMS_plot_SD_data_3pnp_5pt.txt");
	ofstream Bsysunfile;
	Bsysunfile.open("finalANtext/run15_FMS_BSystematic_SD_summary_3pnp.txt");
	ofstream Ysysunfile;
	Ysysunfile.open("finalANtext/run15_FMS_YSystematic_SD_summary_3pnp.txt");
