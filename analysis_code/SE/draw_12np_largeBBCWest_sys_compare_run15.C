void draw_12np_largeBBCWest_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_12np_West_Sys_largeBBC.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_12np_West_Sys_largeBBC_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("largeBBCW450_12np.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[2] >> YellowANErr_4045[2]  ;
    	...
    	ifstream inputtext;
    	//inputtext.open("largeBBCW350_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SyslargeBBC_m20.txt");
	...
	//YellowANDiff_un_far[4] = YellowANDiff_un_3045[0];
    	...
    	ifstream inputtext;
    	//inputtext.open("largeBBCW400_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SyslargeBBC_m10.txt");
	...
	//YellowANDiff_un_3045[2] = 0;
    	...
    	ifstream inputtext;
    	//inputtext.open("largeBBCW500_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SyslargeBBC_p10.txt");
	...
	//YellowANDiff_un_3045[3] = sqrt(fabs(pow(YellowANErr_3045[3] , 2) - pow(YellowANErr_3045[2] ,2)));
    	...
    	ifstream inputtext;
    	//inputtext.open("largeBBCW550_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SyslargeBBC_p20.txt");
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_largeBBCstudy_West_12np_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_largeBBCstudy_West_12np_Sys.pdf");
