void draw_12np_ROFWest_sys_compare_run15()
{
	...
	Double_t ANpoint_1520[2] = {0.17,0.175};
	Double_t ANpoint_2025[2] = {0.22,0.225};
	Double_t ANpoint_2530[2] = {0.27,0.275};
	Double_t ANpoint_3035[2] = {0.32,0.325};
	Double_t ANpoint_3540[2] = {0.37,0.375};
	Double_t ANpoint_4045[2] = {0.42,0.425};
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_12np_West_Sys_ROF.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_12np_West_Sys_ROF_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("ROFW450_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_result.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[1] >> YellowANErr_4045[1]  ;
    	...
    	ifstream inputtext;
    	//inputtext.open("ROFW350_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysROF.txt");
...
//    	ifstream inputtext;
//    	//inputtext.open("ROFW400_12np.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_12np_SysROF_m10.txt");
//
//	inputtext >> beam >> XFpoint >> AN_1520[1] >> ANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> YellowAN_1520[1] >> YellowANErr_1520[1]  ;
//	inputtext >> beam >> XFpoint >> AN_2025[1] >> ANErr_2025[1]  ;
...
//
//    	ifstream inputtext;
//    	//inputtext.open("ROFW500_12np.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_12np_SysROF_p10.txt");
//
...
//
//    	ifstream inputtext;
//    	//inputtext.open("ROFW550_12np.txt");
//    	inputtext.open("ANtext/Run15FMSfinal_12np_SysROF_p20.txt");
//
...
//	//YellowANDiff_un_3045[4] = sqrt(fabs(pow(YellowANErr_3045[4] , 2) - pow(YellowANErr_3045[2] ,2)));
	...
	meanBlueAN = 1.0 * meanBlueAN / 2.0;
	meanYellowAN = 1.0 * meanYellowAN / 2.0;
	for (int i=0; i<2; i++)
	{
	...
	StdDevBlueAN = sqrt(1.0 * StdDevBlueAN / 2.0);
	StdDevYellowAN = sqrt(1.0 * StdDevYellowAN / 2.0);
	...
	TH2D * temp = new TH2D("temp","Blue beam A_{N}",8,0.20,0.45,30,-0.3,0.2);
	...
	BlueBeamAN1520 = new TGraphErrors(2, ANpoint_1520 , AN_1520, ANpointErr, ANErr_1520);
	BlueBeamAN1520->SetName("BlueBeamAN1520");
	BlueBeamAN1520->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN1520->GetXaxis()->SetTitle("small west BBC cut");
	...
	BlueBeamAN2025 = new TGraphErrors(2, ANpoint_2025 , AN_2025, ANpointErr, ANErr_2025);
	BlueBeamAN2025->SetName("BlueBeamAN2025");
	BlueBeamAN2025->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN2025->GetXaxis()->SetTitle("small west BBC cut");
	...
	BlueBeamAN2530 = new TGraphErrors(2, ANpoint_2530 , AN_2530, ANpointErr, ANErr_2530);
	BlueBeamAN2530->SetName("BlueBeamAN2530");
	BlueBeamAN2530->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN2530->GetXaxis()->SetTitle("small west BBC cut");
	...
	BlueBeamAN3035 = new TGraphErrors(2, ANpoint_3035 , AN_3035, ANpointErr, ANErr_3035);
	BlueBeamAN3035->SetName("BlueBeamAN3045");
	BlueBeamAN3035->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN3035->GetXaxis()->SetTitle("small west BBC cut");
	...
	BlueBeamAN3540 = new TGraphErrors(2, ANpoint_3540 , AN_3540, ANpointErr, ANErr_3540);
	BlueBeamAN3540->SetName("BlueBeamAN3045");
	BlueBeamAN3540->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN3540->GetXaxis()->SetTitle("small west BBC cut");
	...
	BlueBeamAN4045 = new TGraphErrors(2, ANpoint_4045 , AN_4045, ANpointErr, ANErr_4045);
	BlueBeamAN4045->SetName("BlueBeamAN3045");
	BlueBeamAN4045->SetTitle("Blue beam A_{N} for BBC cuts");
	BlueBeamAN4045->GetXaxis()->SetTitle("small west BBC cut");
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_ROFstudy_West_12np_Sys.pdf");
...
//
	TCanvas *ANplot = new TCanvas("ANPlot","",1024,768);
	ANplot->DrawFrame(2., -0.06, 250., 0.2);
	TH2D * temp = new TH2D("temp","Yellow beam A_{N}",8,0.20,0.45,30,-0.3,0.2);
	temp->GetYaxis()->SetTitle("Yellow beam A_{N}");
  	temp->GetYaxis()->SetTitleOffset(0.9);
  	temp->GetXaxis()->SetTitle("|x_{F}|");
  	temp->Draw();

	YellowBeamAN1520 = new TGraphErrors(2, ANpoint_1520 , YellowAN_1520, ANpointErr, YellowANErr_1520);
	...
	YellowBeamAN2025 = new TGraphErrors(2, ANpoint_2025 , YellowAN_2025, ANpointErr, YellowANErr_2025);
	...
	YellowBeamAN2530 = new TGraphErrors(2, ANpoint_2530, YellowAN_2530, ANpointErr, YellowANErr_2530);
	...
	YellowBeamAN3045 = new TGraphErrors(2, ANpoint_3035 , YellowAN_3035, ANpointErr, YellowANErr_3035);
	...
	YellowBeamAN3540 = new TGraphErrors(2, ANpoint_3540 , YellowAN_3540, ANpointErr, YellowANErr_3540);
	...
	YellowBeamAN4045 = new TGraphErrors(2, ANpoint_4045 , YellowAN_4045, ANpointErr, YellowANErr_4045);
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_ROFstudy_West_12np_Sys.pdf");
...
//	leg->Draw("same");
//
//	//ANplot->SaveAs("FMS_BlueAN_BBCstudy_12np.pdf");
...
//  	temp->GetYaxis()->SetTitleOffset(0.9);
//  	temp->GetXaxis()->SetTitle("small west BBC cut");
//  	temp->Draw();
//
...
//	BlueBeamANdiff1015->GetXaxis()->SetTitle("small west BBC cut");
...
//	BlueBeamANdiff1520->GetXaxis()->SetTitle("small west BBC cut");
...
//	BlueBeamANdiff2025->GetXaxis()->SetTitle("small west BBC cut");
...
//	BlueBeamANdiff2530->GetXaxis()->SetTitle("small west BBC cut");
...
//	BlueBeamANdiff3045->GetXaxis()->SetTitle("small west BBC cut");
...
//	YellowBeamANdiff1015->GetXaxis()->SetTitle("small west BBC cut");
...
//	YellowBeamANdiff1520->GetXaxis()->SetTitle("small west BBC cut");
...
//	YellowBeamANdiff2025->GetXaxis()->SetTitle("small west BBC cut");
...
//	YellowBeamANdiff2530->GetXaxis()->SetTitle("small west BBC cut");
...
//	YellowBeamANdiff3045->GetXaxis()->SetTitle("small west BBC cut");
