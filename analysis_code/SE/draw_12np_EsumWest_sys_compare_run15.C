void draw_12np_EsumWest_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_12np_West_Sys_Esum.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_12np_West_Sys_Esum_noconstrain.txt");

    	ifstream inputtext;
    	//inputtext.open("EsumW450_12np.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[2] >> YellowANErr_4045[2]  ;
    	...
    	ifstream inputtext;
    	//inputtext.open("EsumW350_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysEsumm10.txt");
	...
	//YellowANDiff_un_far[4] = YellowANDiff_un_3045[0];
    	...
    	ifstream inputtext;
    	//inputtext.open("EsumW400_12np.txt");
    	//inputtext.open("ANtext/Run15FMSfinal_12np_SysEsum_m10.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysEsumm5.txt");
...
//
//	ifstream inputtext;
//    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysEsump5.txt");
//	//inputtext.open("EsumW450_12np.txt");
//	
...
//
    	ifstream inputtext;
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysEsump5.txt");
    	//inputtext.open("EsumW500_12np.txt");
    	//inputtext.open("ANtext/Run15FMSfinal_12np_SysEsum_p10.txt");
...
//
    	ifstream inputtext;
    	//inputtext.open("EsumW550_12np.txt");
    	inputtext.open("ANtext/Run15FMSfinal_12np_West_SysEsump10.txt");
...
//	//YellowANDiff_un_3045[4] = sqrt(fabs(pow(YellowANErr_3045[4] , 2) - pow(YellowANErr_3045[2] ,2)));
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_Esumstudy_West_12np_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_Esumstudy_West_12np_Sys.pdf");
