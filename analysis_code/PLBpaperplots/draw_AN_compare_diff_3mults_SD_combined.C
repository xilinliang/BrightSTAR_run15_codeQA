...
void draw_AN_compare_diff_3mults_SD_combined()
{
	...
	ifstream AN_all;
	AN_all.open("finalANtext/run15_FMS_plot_SD_data_5pt.txt");
	ifstream AN_12np;
	AN_12np.open("finalANtext/run15_FMS_plot_SD_data_12np_5pt.txt");
	ifstream AN_3pnp;
	AN_3pnp.open("finalANtext/run15_FMS_plot_SD_data_3pnp_5pt.txt");
	...
	AN_all_Graph = new TGraphErrors(5,ANallpoint,ANall,xPointun,ANallun);
	AN_12np_Graph = new TGraphErrors(5,AN12nppoint,AN12np,xPointun,AN12npun);
	AN_3pnp_Graph = new TGraphErrors(5,AN3pnppoint,AN3pnp,xPointun,AN3pnpun);

	AN_all_Graph_Sys = new TGraphErrors(5,ANallpoint,ANall,ANallpointun,ANallsys);
	AN_12np_Graph_Sys = new TGraphErrors(5,AN12nppoint,AN12np,AN12nppointun,AN12npsys);
	AN_3pnp_Graph_Sys = new TGraphErrors(5,AN3pnppoint,AN3pnp,AN3pnppointun,AN3pnpsys);
	...
	ANY_all_Graph = new TGraphErrors(5,ANYallpoint,ANYall,xPointun,ANYallun);
	ANY_12np_Graph = new TGraphErrors(5,ANY12nppoint,ANY12np,xPointun,ANY12npun);
	ANY_3pnp_Graph = new TGraphErrors(5,ANY3pnppoint,ANY3pnp,xPointun,ANY3pnpun);
	ANY_all_Graph_Sys = new TGraphErrors(5,ANYallpoint,ANYall,ANYallpointun,ANYallsys);
	ANY_12np_Graph_Sys = new TGraphErrors(5,ANY12nppoint,ANY12np,ANY12nppointun,ANY12npsys);
	ANY_3pnp_Graph_Sys = new TGraphErrors(5,ANY3pnppoint,ANY3pnp,ANY3pnppointun,ANY3pnpsys);

	//TCanvas *ANplot = new TCanvas("ANPlot","",200,10,1024,768);
        //ANplot->DrawFrame(2., -0.06, 250., 0.2);
	TH2D * htemp = new TH2D("temp","",8,0.195,0.45,30,-0.099,0.119);
        htemp->GetYaxis()->SetTitleOffset(0.9);
        //htemp->GetXaxis()->SetTitle("|x_{F}|");
        htemp->GetXaxis()->SetTitle("x_{F}");
        htemp->GetYaxis()->SetTitle("A_{N}");
        //htemp->Draw();
        AN_all_Graph->SetMarkerColor(kBlue+1);
	AN_all_Graph->SetLineWidth(2);
        AN_all_Graph->SetMarkerSize(2);
        AN_all_Graph->SetMarkerStyle(22);
	AN_all_Graph->SetLineColor(kBlue+1);
        AN_12np_Graph->SetMarkerColor(kBlue+1);
	AN_12np_Graph->SetLineWidth(2);
        AN_12np_Graph->SetMarkerSize(2);
        AN_12np_Graph->SetMarkerStyle(22);
	AN_12np_Graph->SetLineColor(kBlue+1);
        AN_3pnp_Graph->SetMarkerColor(kBlue+1);
	AN_3pnp_Graph->SetLineWidth(2);
        AN_3pnp_Graph->SetMarkerSize(2);
	AN_3pnp_Graph->SetLineColor(kBlue+1);
        AN_3pnp_Graph->SetMarkerStyle(22);
	AN_all_Graph_Sys->SetMarkerColor(kBlue+1);
	AN_all_Graph_Sys->SetMarkerSize(2);
        AN_all_Graph_Sys->SetMarkerStyle(22);
	...
	AN_12np_Graph_Sys->SetMarkerColor(kBlue+1);
	AN_12np_Graph_Sys->SetMarkerSize(2);
        AN_12np_Graph_Sys->SetMarkerStyle(22);
	...
	AN_3pnp_Graph_Sys->SetMarkerColor(kBlue+1);
	AN_3pnp_Graph_Sys->SetMarkerSize(2);
	AN_3pnp_Graph_Sys->SetLineColor(0);
        AN_3pnp_Graph_Sys->SetMarkerStyle(22);
	AN_3pnp_Graph_Sys->SetLineWidth(0);
	AN_3pnp_Graph_Sys->SetFillStyle(3001);
	AN_3pnp_Graph_Sys->SetFillColorAlpha(28,0.85);

        ANY_all_Graph->SetMarkerColor(kRed+1);
	ANY_all_Graph->SetLineWidth(2);
        ANY_all_Graph->SetMarkerSize(2);
	ANY_all_Graph->SetLineColor(kRed+1);
        ANY_all_Graph->SetMarkerStyle(26);
        ANY_12np_Graph->SetMarkerColor(kRed+1);
	ANY_12np_Graph->SetLineWidth(2);
        ANY_12np_Graph->SetMarkerSize(2);
	ANY_12np_Graph->SetLineColor(kRed+1);
        ANY_12np_Graph->SetMarkerStyle(26);
        ANY_3pnp_Graph->SetMarkerColor(kRed+1);
	ANY_3pnp_Graph->SetLineWidth(2);
        ANY_3pnp_Graph->SetMarkerSize(2);
        ANY_3pnp_Graph->SetMarkerStyle(26);
	ANY_3pnp_Graph->SetLineColor(kRed+1);
	ANY_all_Graph_Sys->SetMarkerColor(kRed+1);
	ANY_all_Graph_Sys->SetMarkerSize(2);
        ANY_all_Graph_Sys->SetMarkerStyle(26);
	...
	ANY_12np_Graph_Sys->SetMarkerColor(kRed+1);
	ANY_12np_Graph_Sys->SetMarkerSize(2);
        ANY_12np_Graph_Sys->SetMarkerStyle(26);
	...
	ANY_3pnp_Graph_Sys->SetMarkerColor(kRed+1);
	ANY_3pnp_Graph_Sys->SetMarkerSize(2);
	ANY_3pnp_Graph_Sys->SetLineColor(0);
        ANY_3pnp_Graph_Sys->SetMarkerStyle(26);
	...
	ANY_3pnp_Graph_Sys->SetFillColorAlpha(28,0.85);
        ...
        TLine *line1 = new TLine(0.195, 0, 0.45, 0);
		...
		for (Int_t j=0; j<Ny;j++)
		{
			...
			if (j==0)
			{
				...
				TLatex T5;
   				...
   				T5.DrawLatex(0.27,0.092,"Photon multiplicity #geq 3");
				T5->Draw("same");

				TLatex T8;
        			T8.SetTextAlign(11);
        			T8.SetTextSize(0.055);
        			T8.SetTextColor(kBlack);
   				T8.DrawLatex(0.29,-0.054,"2.8 < #eta^{EM-jet} < 3.8");
   				T8.DrawLatex(0.29,-0.072,"p^{EM-jet}_{T} > 2.0 GeV/c");
   				T8.DrawLatex(0.29,-0.090,"3.0\% polarization scale uncertainty not shown");
				T8->Draw("same");
			...
			if (j==1)
			{
				...
				TLegend *leg = new TLegend(0.20,0.06,0.68,0.20);
				...
				TLatex T4;
        			T4.SetTextAlign(11);
        			T4.SetTextSize(0.11);
   				T4.DrawLatex(0.25,0.092,"Photon multiplicity = 1 or 2");
				T4->Draw("same");
			...
			if (j==2)
			{
				...
				TLatex T2;
   				...
   				T2.DrawLatex(0.28,-0.071,"p^{#uparrow} + p #rightarrow EM jet + p + X");
   				T2.DrawLatex(0.28,-0.089,"#sqrt{s} = 200 GeV");
				T2->Draw("same");

				TLatex T3;
        			T3.SetTextAlign(11);
        			T3.SetTextSize(0.088);
   				T3.DrawLatex(0.273,0.092,"All photon multiplicity");
				T3->Draw("same");
	...
	//C->SaveAs("fig/prelim/Compare_diff_east_all_12np_3pnp.pdf");
	C->SaveAs("fig/PLBpaperplot/Fig3.pdf");
