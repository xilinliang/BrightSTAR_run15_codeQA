void Calc_12np_systematic_All_6ptRG()
{

	ifstream com_sig;
	com_sig.open("ANtext/Run15FMSfinal_12np_RG_result.txt");
	ifstream SBBC;
	SBBC.open("ANtext/Run15FMSfinal_12np_RG_Sys_smallBBC.txt");
	ifstream LBBC;
	LBBC.open("ANtext/Run15FMSfinal_12np_RG_Sys_largeBBC.txt");
	ifstream ROF;
	ROF.open("ANtext/Run15FMSfinal_12np_RG_Sys_ROF.txt");
	//ifstream Dilution;
	...
	ofstream resultfile;
	resultfile.open("finalANtext/run15_FMS_plot_RG_data_12np.txt");
	ofstream Bsysunfile;
	Bsysunfile.open("finalANtext/run15_FMS_BSystematic_RG_summary_12np.txt");
	ofstream Ysysunfile;
	Ysysunfile.open("finalANtext/run15_FMS_YSystematic_RG_summary_12np.txt");
