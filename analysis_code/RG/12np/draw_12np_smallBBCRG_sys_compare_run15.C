void draw_12np_smallBBCRG_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_12np_RG_Sys_smallBBC.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_12np_RG_Sys_smallBBC_noconstrain.txt");
	...
	//cout << "Blue AN 0.2 - 0.25:" << AN_2025[2] << "	Yellow AN 0.2 - 0.25:" << YellowAN_2025[2] << endl;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_RG_SyssmallBBC_m20.txt");
	...
	//YellowANDiff_un_far[4] = YellowANDiff_un_3045[0];
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_RG_SyssmallBBC_m10.txt");
	...
	//YellowANDiff_un_3045[2] = 0;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_RG_SyssmallBBC_p10.txt");
	...
	//YellowANDiff_un_3045[3] = sqrt(fabs(pow(YellowANErr_3045[3] , 2) - pow(YellowANErr_3045[2] ,2)));
    	...
    	inputtext.open("ANtext/Run15FMSfinal_12np_RG_SyssmallBBC_p20.txt");
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_smallBBCstudy_RG_12np_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_smallBBCstudy_RG_12np_Sys.pdf");
