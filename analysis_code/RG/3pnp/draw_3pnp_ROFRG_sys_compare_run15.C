void draw_3pnp_ROFRG_sys_compare_run15()
{
	...
	ofstream outputtext;
	outputtext.open("ANtext/Run15FMSfinal_3pnp_RG_Sys_ROF.txt");
	ofstream outputtext_no;
	outputtext_no.open("ANtext/Run15FMSfinal_3pnp_RG_Sys_ROF_noconstrain.txt");
	...
	inputtext >> beam >> XFpoint >> YellowAN_4045[1] >> YellowANErr_4045[1]  ;
    	...
    	inputtext.open("ANtext/Run15FMSfinal_3pnp_RG_SysROF.txt");
...
//	//YellowANDiff_un_3045[4] = sqrt(fabs(pow(YellowANErr_3045[4] , 2) - pow(YellowANErr_3045[2] ,2)));
	...
	//leg->Draw("same");
//
	ANplot->SaveAs("fig/sys/FMS_BlueAN_ROFstudy_RG_3pnp_Sys.pdf");
...
//
	...
	ANplot->SaveAs("fig/sys/FMS_YellowAN_ROFstudy_RG_3pnp_Sys.pdf");
