...
void DiffJetXFANCalc_6pt_RG(TString inFileName, TString outName, TString outNameText, TString photon, TString det)
{
	...
	YellowBeamAN->Fit("ANconstantY","0");
	...
	TH2D * temp = new TH2D("temp","A_{N}",8,0.15,0.45,30,-0.08,0.08);
...
//	BlueBeamSys->Draw("e5");
	...
	TLegend *leg = new TLegend(0.15,0.30,0.23,0.42);
...
//	T1.DrawLatex(0.11,-0.11,"STAR Preliminary");
	...
	TLatex T2;
   	...
   	T2.DrawLatex(0.16,-0.06,"#sqrt{s} = 200 GeV");
   	T2.DrawLatex(0.16,-0.07,"3.0\% polarization scale uncertainty not shown");
	

	if (photon == "all")
	{

		ANplot->SaveAs("FMS_ANplot_RG.pdf");
		ANplot->SaveAs("FMS_ANplot_RG.png");
		ANplot->SaveAs("FMS_ANplot_RG.root");

	}
	if (photon == "12np")
	{

		ANplot->SaveAs("FMS_ANplot_12np_RG.pdf");
		ANplot->SaveAs("FMS_ANplot_12np_RG.png");
		ANplot->SaveAs("FMS_ANplot_12np_RG.root");

	}
	if (photon == "3pnp")
	{

		ANplot->SaveAs("FMS_ANplot_3pnp_RG.pdf");
		ANplot->SaveAs("FMS_ANplot_3pnp_RG.png");
		ANplot->SaveAs("FMS_ANplot_3pnp_RG.root");
