...
void DiffJetXFANCalc_6pt_SE(TString inFileName, TString outName, TString outNameText, TString photon, TString det)
{
	...
	TH2D * temp = new TH2D("temp","A_{N}",8,0.15,0.45,30,-0.40,0.10);
...
//	T1.DrawLatex(0.11,-0.11,"STAR Preliminary");
	...
	TLatex T2;
   	...
   	T2.DrawLatex(0.16,-0.29,"p^{#uparrow} + p #rightarrow EM jet + p^{#uparrow} + X");
   	T2.DrawLatex(0.16,-0.32,"#sqrt{s} = 200 GeV");
   	T2.DrawLatex(0.16,-0.35,"3.0\% polarization scale uncertainty not shown");
