    ...
    case RG:
	    ...
	    switch ("$2")
	    	...
	    	case AN:
	    		...
	    		set output_root = 'Run15FMSXFCalc_RG_$JOBINDEX.root'
			set output_rootall = 'Run15FMSXFCalc_RG_*.root'
	    	...
	    	case smallBBC:
	    		...
	    		set output_root1 = 'Run15FMSXFCalc_RG_SmallBBCEp20_$JOBINDEX.root'
	    		set output_root2 = 'Run15FMSXFCalc_RG_SmallBBCEp10_$JOBINDEX.root'
	    		set output_root3 = 'Run15FMSXFCalc_RG_SmallBBCEm10_$JOBINDEX.root'
	    		set output_root4 = 'Run15FMSXFCalc_RG_SmallBBCEm20_$JOBINDEX.root'
			set output_rootall = 'Run15FMSXFCalc_RG_SmallBBCE*.root'
			set output_destination = 'root_result/Run15FMSRGSys/'
	    	...
	    	case largeBBC:
	    		...
	    		set output_root1 = 'Run15FMSXFCalc_RG_LargeBBCEp20_$JOBINDEX.root'
	    		set output_root2 = 'Run15FMSXFCalc_RG_LargeBBCEp10_$JOBINDEX.root'
	    		set output_root3 = 'Run15FMSXFCalc_RG_LargeBBCEm10_$JOBINDEX.root'
	    		set output_root4 = 'Run15FMSXFCalc_RG_LargeBBCEm20_$JOBINDEX.root'
			set output_rootall = 'Run15FMSXFCalc_RG_LargeBBCE*.root'
			set output_destination = 'root_result/Run15FMSRGSys/'
	    	...
	    	case ROF:
	    		...
	    		set output_root = 'Run15FMSXFCalc_RG_ROF_$JOBINDEX.root'
			set output_rootall = 'Run15FMSXFCalc_RG_ROF_*.root'
			set output_destination = 'root_result/Run15FMSRGSys/'
  			set argument1 = 'root4star -l -q -b '"$jobMacro"'\(\"\$INPUTFILE0\",\"'"$output_root"'\",\"'"$mode"'\",\"'"$process"'\"\)'
			set argument2 = ""
			set argument3 = ""
